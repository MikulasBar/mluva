use super::expr::Expr;
use crate::{Type, ast::pattern::Pattern, diagnostics::Span};
...
impl Statement {
    ...
    pub fn var_declare(ty: Option<Type>, assignee: Pattern, value: Expr, span: Span) -> Self {
        Self {
